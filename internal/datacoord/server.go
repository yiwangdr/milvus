...
func (s *Server) initMeta(chunkManager storage.ChunkManager) error {
	...
	log.Info(fmt.Sprintf("data coordinator connecting to metadata store %s.", metaType))
	...
	log.Info(fmt.Sprintf("data coordinator successfully connected to metadata store %s.", metaType))
